...
MODEL_NAME = "qwen2.5:14b" # Optimizado para Qwen

def classify_abstract_strict(abstract_text):
    # PROMPT OPTIMIZADO PARA QWEN 2.5
...
"""
    ...
    payload = {
        "model": MODEL_NAME,
        "prompt": prompt,
        "format": "json", # Qwen soporta esto perfectamente, garantizando JSON puro
        "stream": False,
        "options": {
            "temperature": 0.0, # Mantenemos 0.0 para ser analíticos y consistentes
            "top_p": 0.9
        }
    }
...
# Usamos enumerate para que el contador vaya del 1 al 108 visualmente
