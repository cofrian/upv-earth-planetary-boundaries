...
\begin{figure}[h]
\centering
\includegraphics[width=\linewidth]{fotos/01_corpus_overview.png}
...
\includegraphics[width=\linewidth]{fotos/21_lollipop_ranking.png}
\caption{Ranking tipo \emph{lollipop}.}
\end{subfigure}
\hfill
\begin{subfigure}{0.48\linewidth}
\includegraphics[width=\linewidth]{fotos/02_pb_radial_signature.png}
\caption{Firma radial (perfil institucional).}
\end{subfigure}\\[0.6em]
\begin{subfigure}{\linewidth}
\centering
\includegraphics[width=0.85\linewidth]{fotos/22_treemap_families.png}
...
\includegraphics[width=\linewidth]{fotos/23_stacked_area_absolute.png}
\caption{Volumen absoluto por PB y año.}
\end{subfigure}
\hfill
\begin{subfigure}{0.49\linewidth}
\includegraphics[width=\linewidth]{fotos/24_streamgraph_normalized.png}
...
\begin{subfigure}{\linewidth}
\centering
\includegraphics[width=0.7\linewidth]{fotos/25_radial_doublelayer.png}
\caption{Radial doble capa: 1995--2015 (interior) vs 2016--2024 (exterior).}
\end{subfigure}\\[0.4em]
\begin{subfigure}{\linewidth}
\centering
\includegraphics[width=0.92\linewidth]{fotos/26_radial_small_multiples.png}
...
\begin{figure}[h]
\centering
\includegraphics[width=0.95\linewidth]{fotos/06_pb_multilabel.png}
...
\begin{subfigure}{\linewidth}
\centering
\includegraphics[width=0.95\linewidth]{fotos/03_pb_cooccurrence_heatmaps.png}
\caption{Heatmap de coocurrencia (izq.\ bruto, dcha.\ Jaccard normalizado).}
\end{subfigure}\\[0.5em]
\begin{subfigure}{\linewidth}
\centering
\includegraphics[width=0.7\linewidth]{fotos/04_pb_network.png}
...
\begin{figure}[h]
\centering
\includegraphics[width=0.85\linewidth]{fotos/07_semantic_umap.png}
...
\begin{figure}[h]
\centering
\includegraphics[width=0.85\linewidth]{fotos/28_sankey_topics_pbs.png}
...
\begin{figure}[h]
\centering
\includegraphics[width=\linewidth]{fotos/09_metrics_overview.png}
...
\centering
\begin{subfigure}{0.49\linewidth}
\includegraphics[width=\linewidth]{fotos/19_success_formula.png}
\caption{Fórmula A: éxito ponderado.}
\end{subfigure}
\hfill
\begin{subfigure}{0.49\linewidth}
\includegraphics[width=\linewidth]{fotos/20_rank_score.png}
...
\begin{figure}[h]
\centering
\includegraphics[width=\linewidth]{fotos/15_confusion_per_model.png}
...
29 figuras totales en \texttt{docs/eda/aed/fotos/}, datos plot-ready de cada figura en \texttt{docs/eda/aed/data\_json/}. Tablas reutilizables en \texttt{docs/eda/aed/tables/}. Predicciones de los 6 modelos sobre los 31\,560 abstracts en \texttt{nlp/bert\_finetuning/outputs\_full/}.
