...
\begin{figure}[h]
\centering
\includegraphics[width=\linewidth]{figures/30_publication_trends.png}
...
\begin{figure}[h]
\centering
\includegraphics[width=0.82\linewidth]{figures/31_top_journals.png}
...
\begin{figure}[h]
\centering
\includegraphics[width=\linewidth]{figures/32_length_distribution.png}
...
\begin{figure}[h]
\centering
\includegraphics[width=\linewidth]{figures/33_top_ngrams.png}
...
\begin{figure}[h]
\centering
\includegraphics[width=0.82\linewidth]{figures/35_wordcloud_global.png}
...
\begin{figure}[h]
\centering
\includegraphics[width=\linewidth]{figures/34_emerging_terms.png}
...
\begin{figure}[h]
\centering
\includegraphics[width=\linewidth]{figures/36_sources_completeness.png}
...
\begin{figure}[h]
\centering
\includegraphics[width=\linewidth]{figures/37_authorship_collaboration.png}
...
\hrule height 0.3pt
\medskip
\small\textit{Reproducible mediante \file{python scripts/aed\_publication\_trends.py}. Figuras en \file{docs/eda/aed/figures/} (30--37). Datos plot-ready en \file{docs/eda/aed/data\_json/}.}
