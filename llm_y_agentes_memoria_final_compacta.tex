...
% Las figuras de esta seccion se esperan en ./figures_llm_y_agentes/ junto al main.tex.
...
\llmfixedfigure{0.82\linewidth}{figures_llm_y_agentes/llm_fewshot_top1_bias.png}{Evolución de Top-1 y positivity bias en las versiones few-shot. v4 sube el acierto sin repetir el sobre-etiquetado de v2.}{fig:llm-fewshot-top1-bias}
...
\llmfixedfigure{0.78\linewidth}{figures_llm_y_agentes/llm_v4_confusion_matrix_norm.png}{Matriz de confusión normalizada de \texttt{v4\_principle}. La diagonal muestra recall por PB; la columna \texttt{None} muestra falsos negativos y la fila \texttt{None} falsos positivos.}{fig:llm-v4-confusion}
...
\llmfixedfigure{0.66\linewidth}{figures_llm_y_agentes/llm_v3_v4_winloss.png}{Comparación pareada v3 frente a v4. v4 corrige 15 documentos que v3 fallaba y solo pierde 4 que v3 acertaba.}{fig:llm-v3-v4-winloss}
...
\llmfixedfigure{0.86\linewidth}{figures_llm_y_agentes/llm_agent_cascade_compact.png}{Cascada final simplificada. Las señales auxiliares ayudan al juez, pero no sustituyen la lectura del abstract.}{fig:llm-agent-cascade}
...
\llmfixedfigure{0.98\linewidth}{figures_llm_y_agentes/fig1_architecture.png}{Arquitectura de la cascada multi-agente. La clave de diseño es que cada bloque tiene una responsabilidad acotada: extracción, evidencia léxica, juicio científico y crítica asimétrica.}{fig:cascade-architecture}

\llmfixedfigure{0.98\linewidth}{figures_llm_y_agentes/fig2_data_flow.png}{Flujo de datos por documento. Las señales auxiliares se pasan al juez como evidencia no autoritativa para evitar que sustituyan la lectura directa del abstract.}{fig:cascade-flow}
...
\llmfixedfigure{0.82\linewidth}{figures_llm_y_agentes/fig7_critic_impact.png}{Impacto del critic asimétrico. La figura separa los casos conservados como \texttt{None} y los overrides, mostrando que la crítica se usa como mecanismo puntual de recuperación de falsos negativos, no como segunda clasificación general.}{fig:critic-impact}
...
\llmfixedfigure{0.92\linewidth}{figures_llm_y_agentes/fig3_compare_systems.png}{Comparación visual de sistemas sobre el conjunto de validación. La figura resume la tensión entre accuracy global, rendimiento sobre documentos con PB real y capacidad de rechazo en documentos \texttt{None}.}{fig:llm-system-comparison}

\llmfixedfigure{0.90\linewidth}{figures_llm_y_agentes/fig6_pipeline_vs_v4.png}{Comparación documento a documento entre el baseline v4 y la cascada. Esta visualización es útil para defender que el análisis no se limita a una media agregada: muestra qué sistema acierta o falla en cada paper.}{fig:pipeline-vs-v4}

\llmfixedfigure{0.95\linewidth}{figures_llm_y_agentes/fig5_per_class_f1.png}{Métricas por clase de la cascada. La variación entre PBs muestra que el rendimiento global no debe interpretarse de forma homogénea: PB9 es más estable por su vocabulario físico distintivo, mientras que PB5/PB6/PB8 sufren por bajo soporte o vocabulario incompleto.}{fig:per-class-f1}
...
\llmfixedfigure{0.92\linewidth}{figures_llm_y_agentes/fig8_failure_taxonomy.png}{Taxonomía de fallos observada en el análisis de la cascada. El valor metodológico de la taxonomía es que convierte errores agregados en acciones concretas de mejora.}{fig:failure-taxonomy}
...
\item Figuras listas en Overleaf: \texttt{figures_llm_y_agentes/}
\end{itemize}
