...
\subsection{Objetivo de modelado}
...
\subsection{Datos, ground truth y protocolo de validación}
...
\subsection{Marco de referencia PB como base del prompt}
...
\subsection{Selección del modelo base: Llama, Qwen y Gemma}
...
\subsection{Evolución de modelos y prompts}
...
\subsubsection{Mapa de iteraciones}
...
\subsubsection{Baseline zero-shot estricto}
...
\subsubsection{Few-shot v1: el fallo del ejemplo rígido}
...
\subsubsection{Few-shot v2 / zero-shot CoT: checklist deductivo}
...
\subsubsection{Few-shot v3: filtro background-vs-focus}
...
\subsubsection{V4 principle-driven: objeto operacional y calibration cases}
...
\subsubsection{Matrices de confusión de las versiones few-shot}
...
\subsubsection{Anatomía de prompts}
...
\subsection{Comparativa single-model: zero-shot y few-shot}
...
\subsection{Arquitectura multi-agente final}
...
\subsubsection{Agente 1: extractor estructurado (\texttt{qwen2.5:3b})}
...
\subsubsection{Scorer determinista por vocabulario}
...
\subsubsection{Router de consenso}
...
\subsubsection{Agente 3: juez experto (\texttt{qwen2.5:14b})}
...
\subsubsection{Agente 4: critic asimétrico}
...
\subsection{Comparativa final: single-model frente a cascada}
...
\subsection{Diagnóstico de errores}
...
\subsubsection{Matriz numérica de la cascada final}
...
\subsubsection{Falsos positivos por ground truth discutible}
...
\subsubsection{Confusión macro-driver vs micro-impact}
...
\subsubsection{Anclaje en señales auxiliares}
...
\subsubsection{Vocabulario incompleto en PB8 y PB1}
...
\subsubsection{Clases con bajo soporte}
...
\subsection{Comparación con modelos embedding/BERT}
...
\subsection{Encaje con la rúbrica de modelos}
...
\subsection{Próximos pasos técnicos}
...
\subsection{Archivos de trazabilidad}
...
\subsection{Texto breve para cerrar la sección en el paper}
